  ...
  public static void main(String[] args) {
    ...
    while (true) {
      try {
        ...
        if (line.equals("end")) {
        ...
        } else if (ui[0].equals("editeReceita")){ // indice e novo valor a ser setado
          int opcao = 0;
        ...
        }else if(ui[0].equals("editeDespesas")) {
          int opcao = 0;
          ...
          System.out.println("Criando conta");
            ...
            System.out.println("Conta cadastrada com sucesso inicie a nova receita"); receita.addConta(new Conta(tipo,ins,0));
        }
        
        else if(ui[0].equals("editConta")){//lista todas as conta
          int opcao = 0;
          System.out.println("\nEscolha uma opçao para editar:\n1)Saldo\n2)tipoConta\n3)Instituiçao Financeira\n");
          opcao = scanner.nextInt();
          ...
          System.out.printf("Insira o indice da conta que retirara o valor: ");
          int sai = scanner.nextInt();
          System.out.printf("Insira o indice da conta que recebera o valor: ");
